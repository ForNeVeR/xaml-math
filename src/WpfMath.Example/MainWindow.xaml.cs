...
namespace WpfMath.Example
{
    public partial class MainWindow : Window
    {
        ...
        private void saveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                case 1:
                    var svgConv = new SVGConverter(formula.FormulaSettingsFile, formula.Formula, formula.Scale, formula.IsSettingsFileInternal)
                    {
                ...
                case 2:
                    using (var stream = new FileStream(filename, FileMode.Create))
                    {
                        ...
                        formulaParser.LoadSettings(formula.FormulaSettingsFile, formula.IsSettingsFileInternal);
