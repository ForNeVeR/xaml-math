...
//                    , group.Transform.Value.M21, group.Transform.Value.M22, group.Transform.Value.OffsetX,
...
//                        {
//                            svgString.Append("L ");
//                            svgString.AppendFormat(CultureInfo.InvariantCulture, "{0} ", (object) seg.Points[i].X);
//                            svgString.AppendFormat(CultureInfo.InvariantCulture, "{0} ", (object) seg.Points[i].Y);
//                        }
//                    }
...
//                            svgString.AppendFormat(CultureInfo.InvariantCulture, "{0} ", (object) seg.Points[i].Y);
//
//                            svgString.AppendFormat(CultureInfo.InvariantCulture, "{0} ", (object) seg.Points[i + 1].X);
//                            svgString.AppendFormat(CultureInfo.InvariantCulture, "{0} ", (object) seg.Points[i + 1].Y);
//
//                            svgString.AppendFormat(CultureInfo.InvariantCulture, "{0} ", (object) seg.Points[i + 2].X);
//                            svgString.AppendFormat(CultureInfo.InvariantCulture, "{0} ", (object) seg.Points[i + 2].Y);
//                        }
//                    }
...
//        {
//            svgString.AppendFormat(CultureInfo.InvariantCulture,
//                "<rect x=\"{0}\" y=\"{1}\" width=\"{2}\" height=\"{3}\" />"
//                , rectangle.Bounds.TopLeft.X, rectangle.Bounds.TopLeft.Y, rectangle.Bounds.Width, rectangle.Bounds.Height);
//            svgString.Append(Environment.NewLine);
//        }
//    }
}