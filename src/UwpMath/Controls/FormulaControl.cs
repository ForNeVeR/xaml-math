...
using UwpMath.Parsers;
using UwpMath.Rendering;
...
public sealed partial class FormulaControl : Control
{
    ...
    private void OnCanvasDraw(CanvasControl sender, CanvasDrawEventArgs args)
    {
        ...
        UwpElementRenderer renderer = new(session) { Scale = FontSize };
    ...
    private Box GetBoxToRender()
    {
        ...
        TexEnvironment environment = UwpTeXEnvironment.Create(
            scale: FontSize,
